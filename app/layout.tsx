...
const siteUrl = "https://lamsah-aldhaqiah.com";

export const metadata: Metadata = {
  metadataBase: new URL(siteUrl),
  title: {
    default: "لمسة للأجهزة الذكية | أفضل الأجهزة بأعلى جودة وأفضل سعر",
    template: "%s | لمسة للأجهزة الذكية",
  },
  description:
  ...
  openGraph: {
    ...
    locale: "ar_SA",
    url: siteUrl,
    siteName: "لمسة للأجهزة الذكية",
    title: "لمسة للأجهزة الذكية | أفضل الأجهزة بأعلى جودة وأفضل سعر",
    description:
